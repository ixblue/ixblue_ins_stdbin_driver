                                   ...
                                   std::size_t bytes_transfered)
{
    ...
    else if(error)
    {
        ...
        RCLCPP_WARN_STREAM(rosPublisher->get_logger(),"Error occurs in IP Listener : " << error.message());
    }
    else
    {
        //RCLCPP_WARN_STREAM_DEBUG_STREAM(rosPublisher->get_logger(),"Received StdBin data");
        ...
        {
            RCLCPP_WARN_STREAM(rosPublisher->get_logger(),"Parse error : " << e.what());
